            ...
            {["Lun","Mar","Mie","Jue","Vie","Sab","Dom"].map((dia, i) => (
              <div key={dia} className="text-center">
                ...
                <div className={`rounded-xl p-2 min-h-24 ${i === 0 ? "bg-orange-50 border border-orange-200" : "bg-gray-50"}`}>
                  ...
                  {i === 0 && <div className="bg-orange-500 text-white text-xs rounded-lg p-1 mb-1">10:00 Destapacion</div>}
                  {i === 1 && <div className="bg-yellow-400 text-white text-xs rounded-lg p-1">14:00 Termotanque</div>}
                </div>
              </div>
            ))}
          </div>
