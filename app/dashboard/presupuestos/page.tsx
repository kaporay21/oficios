      ...
      <main className="flex-1 p-8">
            ...
            <tbody>
              {[
                ...
                <tr key={p.numero} className="border-b border-gray-50 hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4"><span className={`text-xs font-bold px-2 py-1 rounded-full ${p.color}`}>{p.estado}</span></td>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          ...
          <div className="flex gap-3">
            <button className="bg-orange-500 text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-orange-600">Guardar borrador</button>
            <button className="bg-green-500 text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-green-600">Enviar por WhatsApp</button>
          </div>
        </div>
      </main>
    </div>
