      ...
      <aside className="w-64 bg-white shadow-sm min-h-screen p-6 hidden md:block">
        ...
        <nav className="space-y-1">
          {[
            ...
            { label: "Mi plan", href: "/dashboard/plan", activo: true },
          ].map((item) => (
      ...
      <main className="flex-1 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 border-2 border-blue-500 relative">
            ...
            <div className="text-3xl font-bold text-gray-800 mb-4">$7.000<span className="text-sm font-normal text-gray-500">/mes</span></div>
            <div className="space-y-2 mb-6">
            ...
            <button className="w-full bg-blue-500 text-white py-3 rounded-xl font-semibold text-sm hover:bg-blue-600">
              Activar Pro
            </button>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 border-2 border-orange-400">
            ...
            <button className="w-full bg-orange-500 text-white py-3 rounded-xl font-semibold text-sm hover:bg-orange-600">
              Activar Master
            </button>
          </div>
